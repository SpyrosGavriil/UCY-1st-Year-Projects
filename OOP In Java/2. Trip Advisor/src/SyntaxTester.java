...
public class SyntaxTester {
	...
	private static void testFnNames(String className, ArrayList<String> correctMethods,
			ArrayList<String> correctConstructors) throws Exception {
		if (classExists(className)) // Proceed only if the class exists
		{
			...
			for (Method method : studentMethods)
				s_studentMethods.add(method.toString());
			for (Constructor constr : studentConstr)
				s_studentConstr.add(constr.toString());
	...
	private static void evaluate(ArrayList<String> correct, ArrayList<String> student, boolean constr, String className)
		...
		for (String correctString : correct) // we only care about testable methods
		{
			if (!student.contains(correctString)) // signature cannot be found
			{
				String errStr;
				if (constr) {
					errStr = "Error with constructor: " + correctString + " in class: " + className
							+ ". Constructor cannot be found or has wrong signature.";
				} else {
					errStr = "Error with method: " + correctString + " in class: " + className
							+ ". Method cannot be found or has wrong signature.";
				}
	...
	private static void checkField(String className, String fieldType, int quantity, boolean strict) throws Exception {
		...
		if ((strict && foundQty != 0) || (!strict && foundQty > 0))
			throw new Exception(
					"Class " + className + " does not contain the required number of field(s) of type - " + fieldType);
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			String[] classNames = { "Airport", "Basket", "Customer", "Hotel", "Room", "Reservation",
					"FlightReservation", "HotelReservation", "BnBReservation" };
			...
			// Class - Room
			ArrayList<String> correctFnNamesRoom = new ArrayList<String>(
					Arrays.asList("public int " + packageName + "Room.getPrice()",
							"public java.lang.String " + packageName + "Room.getType()",
							"public void " + packageName + "Room.changeAvailability()",
							"public static boolean " + packageName + "Room.makeRoomAvailable(" + packageName
									+ "Room[],java.lang.String)",
							"public static " + packageName + "Room " + packageName + "Room.findAvailableRoom("
									+ packageName + "Room[],java.lang.String)"));
			ArrayList<String> correctConstNamesRoom = new ArrayList<String>(
					Arrays.asList("public " + packageName + "Room(java.lang.String)",
							"public " + packageName + "Room(" + packageName + "Room)"));
			testFnNames(packageName + "Room", correctFnNamesRoom, correctConstNamesRoom);

			// Class - Hotel
			ArrayList<String> correctFnNamesHotel = new ArrayList<String>(
					Arrays.asList("public int " + packageName + "Hotel.reserveRoom(java.lang.String)",
							"public boolean " + packageName + "Hotel.cancelRoom(java.lang.String)"));
			ArrayList<String> correctConstNamesHotel = new ArrayList<String>(
					Arrays.asList("public " + packageName + "Hotel(java.lang.String," + packageName + "Room[])"));
			testFnNames(packageName + "Hotel", correctFnNamesHotel, correctConstNamesHotel);

			// Class - Airport
			ArrayList<String> correctFnNamesAirport = new ArrayList<String>(
					Arrays.asList("public int " + packageName + "Airport.getFees()", "public static int " + packageName
							+ "Airport.getDistance(" + packageName + "Airport," + packageName + "Airport)"));
			ArrayList<String> correctConstNamesAirport = new ArrayList<String>(
					Arrays.asList("public " + packageName + "Airport(int,int,int)"));
			testFnNames(packageName + "Airport", correctFnNamesAirport, correctConstNamesAirport);

			// Class - Reservation
			ArrayList<String> correctFnNamesReservation = new ArrayList<String>(
					Arrays.asList("public final java.lang.String " + packageName + "Reservation.reservationName()",
			...
			ArrayList<String> correctConstNamesReservation = new ArrayList<String>(
					Arrays.asList("public " + packageName + "Reservation(java.lang.String)"));
			testFnNames(packageName + "Reservation", correctFnNamesReservation, correctConstNamesReservation);

			// Class - FlightReservation
			ArrayList<String> correctFnNamesFlightReservation = new ArrayList<String>(
					Arrays.asList("public int " + packageName + "FlightReservation.getCost()",
							"public boolean " + packageName + "FlightReservation.equals(java.lang.Object)"));
			ArrayList<String> correctConstNamesFlightReservation = new ArrayList<String>(
					Arrays.asList("public " + packageName + "FlightReservation(java.lang.String," + packageName
							+ "Airport," + packageName + "Airport)"));
			testFnNames(packageName + "FlightReservation", correctFnNamesFlightReservation,
					correctConstNamesFlightReservation);

			// Class - HotelReservation
			ArrayList<String> correctFnNamesHotelReservation = new ArrayList<String>(
					Arrays.asList("public int " + packageName + "HotelReservation.getNumOfNights()",
							"public int " + packageName + "HotelReservation.getCost()",
							"public boolean " + packageName + "HotelReservation.equals(java.lang.Object)"));
			ArrayList<String> correctConstNamesHotelReservation = new ArrayList<String>(
					Arrays.asList("public " + packageName + "HotelReservation(java.lang.String," + packageName
							+ "Hotel,java.lang.String,int)"));
			testFnNames(packageName + "HotelReservation", correctFnNamesHotelReservation,
					correctConstNamesHotelReservation);

			// Class - BnBReservation
			ArrayList<String> correctFnNamesBnBReservation = new ArrayList<String>(
					Arrays.asList("public int " + packageName + "BnBReservation.getCost()"));
			ArrayList<String> correctConstNamesBnBReservation = new ArrayList<String>(Arrays.asList("public "
					+ packageName + "BnBReservation(java.lang.String," + packageName + "Hotel,java.lang.String,int)"));
			testFnNames(packageName + "BnBReservation", correctFnNamesBnBReservation, correctConstNamesBnBReservation);

			// Class - Basket
			ArrayList<String> correctFnNamesBasket = new ArrayList<String>(
					Arrays.asList("public " + packageName + "Reservation[] " + packageName + "Basket.getProducts()",
			...
			ArrayList<String> correctConstNamesBasket = new ArrayList<String>(
					Arrays.asList("public " + packageName + "Basket()"));
			...
			ArrayList<String> correctFnNamesCustomer = new ArrayList<String>(Arrays.asList(
					...
					"public int " + packageName + "Customer.addToBasket(" + packageName
							+ "Hotel,java.lang.String,int,boolean)",
					"public int " + packageName + "Customer.addToBasket(" + packageName + "Airport," + packageName
							+ "Airport)",
					"public boolean " + packageName + "Customer.removeFromBasket(" + packageName + "Reservation)",
					"public int " + packageName + "Customer.checkOut()"));
			ArrayList<String> correctConstNamesCustomer = new ArrayList<String>(
					Arrays.asList("public " + packageName + "Customer(java.lang.String,int)"));
