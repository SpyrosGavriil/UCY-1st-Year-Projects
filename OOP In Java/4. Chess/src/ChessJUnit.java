...
public class ChessJUnit {
	...
	@Test
	public void testPawn() throws InvalidSquareException {
		Piece pawn = new Pawn(Color.WHITE);
		assertEquals(" ", pawn.algebraicName(), "Algebraic name should be P for pawn.");
		assertEquals(" ", pawn.fenName(), "FEN name should be 'P' for white pawn.");
	...
	@Test
	public void testKing() throws InvalidSquareException {
	...
	@Test
    public void testQueen() throws InvalidSquareException {
        Piece queen = new Queen(Color.WHITE);
        assertEquals("Q", queen.algebraicName());
        assertEquals("Q", queen.fenName());
        Square[] actual = queen.movesFrom(new Square("e2"));
        for(Square sq : actual)
        	System.out.print(sq + " ");
        Square[] expected = {
	...
	@Test
	public void testRook() throws InvalidSquareException {
	...
	@Test
	public void testBishop() throws InvalidSquareException {
	...
	@Test
	public void testKnight() throws InvalidSquareException {
